...
const roles = [
  ...
  'کاربر عادی',
  'ادمن کاربران',
  'اسم خاص طولانی که کاربر مدیرانه و...',
  'مدیر کاربران و دستگاه ها',
  'دسترسی مانیتورینگ و گزارش گیری کلی',
];

export default function RolePopover({ anchorEl, onClose, open }: RolePopoverProps) {
  return (
    <Popover
      open={open}
      anchorEl={anchorEl}
